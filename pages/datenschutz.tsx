	...
	return (
		<>
			...
			<p>
				...
				Geschäftsleitung der DennisDevelops. Eine Nutzung der Internetseiten der
				DennisDevelops ist grundsätzlich ohne jede Angabe personenbezogener
			...
			<p>
				...
				Übereinstimmung mit den für die DennisDevelops geltenden
			...
			<p>
				Die DennisDevelops hat als für die Verarbeitung Verantwortlicher
			...
			<p>
				Die Datenschutzerklärung der DennisDevelops beruht auf den
			...
			<p>72555 Metzingen</p>
			<p>Deutschland</p>
			<p>Tel.: 015234095187</p>
			<p>E-Mail: Dennis-baer@gmx.net</p>
			<p>Website: www.thebear.one</p>

			<h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
			<p>
				Die Internetseite der DennisDevelops erfasst mit jedem Aufruf der
			...
			<p>
				...
				DennisDevelops keine Rückschlüsse auf die betroffene Person. Diese
				...
				erhobenen Daten und Informationen werden durch die DennisDevelops daher
			...
			>
				...
				<li>
					...
					<p>
						...
						DennisDevelops gespeichert sind, veranlassen möchte, kann sie sich
						hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
						Verantwortlichen wenden. Der Mitarbeiter der DennisDevelops wird
						veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
					</p>

					<p>
						Wurden die personenbezogenen Daten von der DennisDevelops öffentlich
						...
						so trifft die DennisDevelops unter Berücksichtigung der verfügbaren
						...
						Mitarbeiter der DennisDevelops wird im Einzelfall das Notwendige
						veranlassen.
					</p>
				</li>
				<li>
					...
					<p>
						...
						bei der DennisDevelops gespeichert sind, verlangen möchte, kann sie
						sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
						Verantwortlichen wenden. Der Mitarbeiter der DennisDevelops wird die
				...
				<li>
					...
					<p>
						...
						betroffene Person jederzeit an einen Mitarbeiter der DennisDevelops
						wenden.
					</p>
				</li>
				<li>
					...
					<p>
						Die DennisDevelops verarbeitet die personenbezogenen Daten im Falle
					...
					<p>
						Verarbeitet die DennisDevelops personenbezogene Daten, um
						...
						DennisDevelops der Verarbeitung für Zwecke der Direktwerbung, so
						wird die DennisDevelops die personenbezogenen Daten nicht mehr für
					...
					<p>
						...
						Verarbeitung personenbezogener Daten, die bei der DennisDevelops zu
					...
					<p>
						...
						Person direkt an jeden Mitarbeiter der DennisDevelops oder einen
				...
				<li>
					...
					<p>
						...
						der betroffenen Person, trifft die DennisDevelops angemessene
			...
			<p>
				...
				<a href="https://abletorecords.com/">gdpr data impact assessment</a>.
